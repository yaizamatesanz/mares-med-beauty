          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Titular:</strong> [NOMBRE COMPLETO DE LA SOCIEDAD O "Daniela Bueno Ventura" si es autónoma]</li>
                ...
                <li><strong>Email:</strong> [EMAIL OFICIAL PARA ASUNTOS LEGALES, ej: info@clinicamares.com]</li>
                <li><strong>Directora Médica:</strong> Dra. Daniela Bueno Ventura (Nº SEME 2898)</li>
                {/* Si es sociedad, añadir: */}
                <li><strong>Datos registrales:</strong> [INSCRITA EN EL REGISTRO MERCANTIL DE LAS PALMAS, TOMO X, FOLIO X, SECCIÓN X, HOJA X]</li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                El presente Aviso Legal regula el acceso y uso del sitio web clinicamares.com (en adelante, el "Sitio Web"), propiedad de [NOMBRE DEL TITULAR]. El acceso al Sitio Web atribuye la condición de usuario e implica la aceptación plena y sin reservas de todas las disposiciones incluidas en este Aviso Legal.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                Todos los contenidos del Sitio Web, incluyendo, sin carácter limitativo, textos, fotografías, gráficos, imágenes, iconos, tecnología, software, links y demás contenidos audiovisuales, así como su diseño gráfico y códigos fuente, son propiedad intelectual de [NOMBRE DEL TITULAR] o de terceros, sin que puedan entenderse cedidos al usuario ninguno de los derechos de explotación sobre los mismos más allá de lo estrictamente necesario para el correcto uso del Sitio Web.
              </p>
              <p>
                Las marcas, nombres comerciales o signos distintivos son titularidad de [NOMBRE DEL TITULAR] o terceros, sin que pueda entenderse que el acceso al Sitio Web atribuya ningún derecho sobre los mismos.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                [NOMBRE DEL TITULAR] no se hace responsable de los daños y perjuicios de cualquier naturaleza que pudieran ocasionarse por:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="space-y-4">
              ...
              <p>
                El Sitio Web puede contener enlaces a sitios web de terceros. [NOMBRE DEL TITULAR] no asume ninguna responsabilidad por el contenido, informaciones o servicios que pudieran aparecer en dichos sitios, que se ofrecen exclusivamente con carácter informativo y que en ningún caso implican relación alguna entre [NOMBRE DEL TITULAR] y las personas o entidades titulares de tales contenidos.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                [NOMBRE DEL TITULAR] se reserva el derecho de efectuar sin previo aviso las modificaciones que considere oportunas en el Sitio Web, pudiendo cambiar, suprimir o añadir tanto los contenidos y servicios que se prestan a través de la misma como la forma en la que éstos aparezcan presentados o localizados.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                La relación entre [NOMBRE DEL TITULAR] y el usuario se regirá por la normativa española vigente. Para la resolución de cualquier controversia que pudiera surgir, las partes se someten a los Juzgados y Tribunales de Las Palmas de Gran Canaria, salvo que la ley disponga otra cosa.
              </p>
            </section>
